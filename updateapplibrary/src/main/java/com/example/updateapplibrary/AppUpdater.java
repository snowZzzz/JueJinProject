...
import com.example.updateapplibrary.service.DownloadService;
import com.example.updateapplibrary.util.PermissionUtils;
...
public class AppUpdater {
    ...
    private IAPPUPHttpManager mHttpManager;
    ...
    public AppUpdater setHttpManager(IAPPUPHttpManager httpManager){
    ...
    public void start(){
        if(mConfig!=null && !TextUtils.isEmpty(mConfig.getUrl())){
            ...
            if(mContext instanceof Activity){
                PermissionUtils.INSTANCE.verifyReadAndWritePermissions((Activity) mContext, UpdateAppConstants.RE_CODE_STORAGE_PERMISSION);
            }
    ...
    private void startDownloadService(){
        ...
        if(mCallback!=null || mHttpManager!=null){//bindService
            ...
            intent.putExtra(UpdateAppConstants.KEY_UPDATE_CONFIG,mConfig);
